...
<div class="pp-ff-content">
    ...
    if ( $settings->select_form_field ) {
        echo do_shortcode( '[formidable id='.absint( $settings->select_form_field ).' title='.$settings->title_field.' description='.$settings->description_field.' ajax=true]' );
    }
    ?>
</div>
