...
.pp-custom-grid-product-rating {
    font-size: 13px;
    margin-bottom: 20px;
}
.pp-custom-grid-product-rating .star-rating:before {
    color: #FFC107;
}
.pp-custom-grid-product-rating .star-rating span:before {
    color: #FFC107;
}
.pp-custom-grid-product-price {
    color: #333;
    font-size: 16px;
    font-weight: bold;
    margin: 8px 0;
}
.pp-custom-grid-product-price .price del {
    font-size: 15px;
    font-weight: 400;
    margin-right: 8px;
    color: #999;
